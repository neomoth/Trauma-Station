...
[Serializable]
[DataDefinition]
public sealed partial class SpawnEntitiesBehavior : IDurabilityThresholdBehavior
{
    /// <summary>
    ...
    public void Execute(EntityUid owner, SharedDurabilitySystem system, EntityUid? cause = null)
    {
        ...
        Vector2 GetRandomVector() => new Vector2(system.Random.NextFloat(-Offset, Offset),
        ...
        foreach (var (entityId, minMax) in Spawn)
        {
            for (var execution = 0; execution < executions; execution++)
            {
                        ...
                        system.EntityManager.ComponentFactory))
                {
                    ...
                    system.EntityManager.System<StackSystem>().SetCount((spawned, null), count);
    ...
    public void TransferForensics(EntityUid spawned, SharedDurabilitySystem system, EntityUid owner)
    {
