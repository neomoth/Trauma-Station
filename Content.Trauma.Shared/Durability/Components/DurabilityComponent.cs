...
public sealed partial class DurabilityComponent : Component
{
    ...
    /// </summary>
    [DataField, AutoNetworkedField] public DurabilityState DurabilityState = DurabilityState.Pristine;

    /// <summary>
    /// Thresholds for when to change state. Entities will attempt to break when reaching <see cref="DurabilityState.Broken"/>.
    /// </summary>
    [DataField] public SortedDictionary<FixedPoint2, DurabilityState> DurabilityThresholds = [];

    /// <summary>
    /// The total amount of damage this entity has sustained.
    /// </summary>
    [DataField, AutoNetworkedField] public FixedPoint2 Damage = 0;

    /// <summary>
    /// The probability that this entity will take damage, between 0 and 1.
    /// </summary>
    [DataField, AutoNetworkedField] public float DamageProbability = 0.35f;
    ...
    /// </summary>
    [DataField] public SortedDictionary<DurabilityState, HashSet<LocId>> DamagePopups = [];
    ...
    /// </summary>
    [DataField(serverOnly: true)] public IThresholdBehavior? OnBreakBehavior;
    ...
    /// </summary>
    [DataField, AutoNetworkedField] public bool DeleteOnDestroyed = true;

    /// <summary>
    /// The popup to show when attempting to swing a weapon entity that is in the <see cref="DurabilityState.Destroyed"/> state.
    /// </summary>
    [DataField] public LocId? DestroyedSwingAttemptPopup = new LocId("durability-attempt-melee-destroyed");

    /// <summary>
    /// Minimum damage that can be dealt to the entity when passing the damage chance.
    /// </summary>
    [DataField, AutoNetworkedField] public FixedPoint2 MinDamageRoll = 3;

    /// <summary>
    /// Maximum damage that can be dealt to the entity when passing the damage chance.
    /// </summary>
    [DataField, AutoNetworkedField] public FixedPoint2 MaxDamageRoll = 6;
    ...
    /// </summary>
    [DataField] public SortedDictionary<DurabilityState, float> DamageModifiers = new()
    {
    ...
    /// </summary>
    [DataField, AutoNetworkedField] public Dictionary<EntProtoId, Vector2> RepairMaterials = [];
    ...
    /// </summary>
    [DataField, AutoNetworkedField] public ProtoId<ToolQualityPrototype>? RepairTool;
    [DataField, AutoNetworkedField] public Vector2 ToolRepairAmount = Vector2.Zero;

    /// <summary>
    /// If using a welder to repair this, how much fuel it should cost.
    /// </summary>
    [DataField, AutoNetworkedField] public float FuelCost;

    /// <summary>
    /// How long it takes to repair this entity via using another entity on it.
    /// </summary>
    [DataField, AutoNetworkedField] public TimeSpan RepairDoAfter = TimeSpan.Zero;

    /// <summary>
    /// Whether this entity can be repaired by any means or not.
    /// </summary>
    [DataField, AutoNetworkedField] public bool Repairable = true;
    ...
    /// </summary>
    [DataField, AutoNetworkedField] public FixedPoint2 MaxRepairBonus;
}
